...
/**
 * Provides the Swing panel used for calendar operations.
 *
...
public class CalendarPanel extends JPanel {
    ...
    /**
     * Creates a new CalendarPanel instance.
    */
    ...
    private JPanel createTopSection() {
        ...
        JLabel title = new JLabel("Kalendar svih rezervacija");
        ...
        container.add(navigationPanel, BorderLayout.CENTER);

        return container;
    }

    private JScrollPane createCalendarTable() {
        return CalendarTableBuilder.build(displayedMonth, this);
    }

    private void updateMonthLabel() {
        String month = displayedMonth
                .getMonth()
                .getDisplayName(TextStyle.FULL, new Locale("hr", "HR"));
